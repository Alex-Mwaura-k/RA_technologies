...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      toast.success('Account created successfully! Welcome to RA Technologies.');
      navigate('/login');
    }, 1500);
  };
  ...
  return (
    <SharedBackground>
      <div className="w-full min-h-screen min-h-[100dvh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-2 overflow-x-hidden box-border">
        ...
        <div className="max-w-md w-full space-y-5 bg-white/90 backdrop-blur-md p-6 sm:p-8 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-200 max-h-[95vh] overflow-y-auto">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-xs sm:text-sm text-slate-600 font-medium">
              Join us and start scaling your infrastructure.
            </p>
          </div>
          ...
          <form className="mt-4 sm:mt-6 space-y-5" onSubmit={handleSubmit}>
            ...
            <p className="text-[11px] sm:text-xs text-center text-slate-500 mt-3">
              By signing up, you agree to our{' '}
              <Link to="/terms-of-service" className="text-blue-600 hover:underline">Terms</Link> and{' '}
              <Link to="/privacy-policy" className="text-blue-600 hover:underline">Privacy</Link>.
            </p>
          </form>

          <div className="text-center text-xs sm:text-sm text-slate-600 font-medium mt-4 pt-4 border-t border-slate-100">
            Already have an account?{' '}
            <Link to="/login" className="text-[var(--tech-blue)] hover:text-blue-700 font-bold transition-colors">
              Sign in
            </Link>
          </div>
        </div>
