              ...
              {teamMembers.map((member) => (
                ...
                >
                  <div className="flex-grow flex flex-col">
                    {/* Member Avatar */}
                    <div className="relative w-full aspect-square rounded-lg overflow-hidden mb-5 bg-slate-100 border border-slate-200/60">
                      <img
                        src={member.image}
                      ...
                      />
                      <span className="absolute top-3 right-3 px-2.5 py-1 bg-slate-900/80 backdrop-blur-md text-[10px] font-semibold text-white rounded-md">
                        {member.category}
                      </span>
                    </div>
                  ...
                  {/* Social Action Footer: Standardized Icon Links */}
                  <div className="pt-4 border-t border-slate-100 flex items-center gap-2">
                    {member.socials.linkedin && (
                      <a
                        ...
                        rel="noreferrer me"
                        itemProp="sameAs"
                        className="p-2 text-slate-500 hover:text-blue-700 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors"
                    ...
                    {member.socials.twitter && (
                      <a
                        ...
                        rel="noreferrer me"
                        itemProp="sameAs"
                        className="p-2 text-slate-500 hover:text-blue-500 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors"
